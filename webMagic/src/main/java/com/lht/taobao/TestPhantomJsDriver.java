...
public class TestPhantomJsDriver {
    ...
    public static PhantomJSDriver getPhantomJSDriver(){
        ...
        //驱动支持
        dcaps.setCapability(PhantomJSDriverService.PHANTOMJS_EXECUTABLE_PATH_PROPERTY,"D:\\chrome\\phantomjs-2.1.1-windows\\bin\\phantomjs.exe");
